...
class AreasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create area" do
    assert_difference('Area.count') do
      post areas_url, params: { area: { icon: @area.icon, name: @area.name, status: @area.status } }, as: :json
    end
  ...
  test "should update area" do
    patch area_url(@area), params: { area: { icon: @area.icon, name: @area.name, status: @area.status } }, as: :json
    assert_response 200
  end
